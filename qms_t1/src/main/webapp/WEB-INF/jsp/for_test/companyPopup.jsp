					...
					<div class="card-body" style="padding-top: 20px;">
						...
						<form id="dataform">
							...
							<table class="table table-hover" id="partnerDetailTable">
								<thead>
									<tr>
										...
										<td><input type="text" class="form-control" id="mcomCd"
											name="compCd" style="width: 400px;"></td>
										<td>
											<div class="icon">
										...
										<td><input type="text" class="form-control"
											id="mcompName" name="compName" style="width: 400px;"></td>
									</tr>
									<tr>
										<th scope="row">거래처유형</th>
										<td><select class="form-control" id="mcompType"
											name="compType" style="width: 400px;">
										...
										<td><input type="text" class="form-control" id="mbizNo"
											name="bizNo" style="width: 400px;"></td>
									</tr>
									<tr>
										<th scope="row">거래여부</th>
										<td><select class="form-control" id="mtradeYn"
											name="tradeYn" style="width: 400px;">
												<option value="">선택하세요</option>
										...
										<td><input type="text" class="form-control" id="mcompCeo"
											name="compCeo" style="width: 400px;"></td>
									</tr>
									<tr>
										<th scope="row">연락처</th>
										<td><input type="text" class="form-control" id="mphone"
											name="phone" style="width: 400px;"></td>
										<td class="icon-cell">&nbsp;</td>
										<th scope="row">이메일</th>
										<td><input type="text" class="form-control" id="memail"
											name="email" style="width: 400px;"></td>
									</tr>
									<tr>
										<th scope="row">주소</th>
										<td colspan="4"><input type="text" class="form-control"
											id="maddr" name="addr" style="width: 962px;"></td>
									</tr>
									<tr>
										<th scope="row">담당자명</th>
										<td><input type="text" class="form-control" id="mmgrName"
											name="mgrName" style="width: 400px;"></td>
										<td class="icon-cell">&nbsp;</td>
										<th scope="row">직위</th>
										<td><input type="text" class="form-control"
											id="mmgrPosition" name="mgrPosition" style="width: 400px;"></td>
									</tr>
									<tr>
										<th scope="row">담당자연락처</th>
										<td colspan="4"><input type="text" class="form-control"
											id="mmgrPhone" name="mgrPhone" style="width: 400px;"></td>
									</tr>
								</thead>
							</table>
							...
							<div style="text-align: center;">
								<button type="button" class="btn btn-primary" id="newSaveBtn"
									onclick="savePartner(1)">저장</button>
								<button type="button" class="btn btn-primary" id="UpdSaveBtn"
									onclick="savePartner(0)">저장</button>
...
<script>
	...
	$(document).ready(
			function() {
				$('#downloadBtn').click(
						function() {
							excelDownload(searchform, '/company/excelDownload',
									'partner_data.xlsx');
						});
			});
	...
	function setRowData(vo) { // 모달 조회 공통쿼리
		...
		str += "<i class=\"ri-search-2-line\" style=\"position: absolute; right: 10px; top: 50%; transform: translateY(-50%); cursor: pointer;\" onclick=\"addItem(this, "
				+ rowCount + ")\"></i></td>";
