         ...
         <div class="modal-content">
           ...
           <table style="width:100%; height:100%;">
			<tr>
               ...
               <td><button type="button" class="btn btn-primary" onclick="search();">조회</button></td>
...
<script>
	...
	function search(){
		call_server(planModalForm, "/plan/selectModalInfo", selectModalInfo);
	}
	var rowidx = 0;
	...
	function addBtn(){
		call_server(planModalForm, "/plan/selectModalInfo", clickbtn);
	}
	...
	function additem(){
		...
		window.open('/bom/bomPopup','popup',option);
	}
	...
	function commit(){
		call_server(planModalForm, "/plan/deleteInsertitem", deleteInsertitem);
	}
	...
	$(function(){
		$("#excelDownload").click(function() {
			excelDownload(searchform, '/plan/downloadProductExcel', 'ProductQty.xlsx');
		});
	})
</script>
